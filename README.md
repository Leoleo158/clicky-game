...
3. When complete, the application should be deployed to Github Pages. See the README generated with Create React App for instructions on deploying the application to Github Pages.
...
- **To launch up my app and play with it please click the link below:**

https://my-app123567.herokuapp.com/
